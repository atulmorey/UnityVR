...
public class GvrReticle : MonoBehaviour, IGvrGazePointer
{
    ...
    public float reticleGrowthSpeed = 0f;
    ...
    private void UpdateDiameters ()
    {
      ...
      Mathf.Clamp (reticleDistanceInMeters, kReticleDistanceMin, kReticleDistanceMax);
        ...
        if (_jsGazeOn)
        {
            ...
            Mathf.Lerp (reticleInnerDiameter, inner_diameter, Time.deltaTime);
            reticleOuterDiameter =
            Mathf.Lerp (reticleOuterDiameter, outer_diameter, Time.deltaTime);
        }
        else
        {
