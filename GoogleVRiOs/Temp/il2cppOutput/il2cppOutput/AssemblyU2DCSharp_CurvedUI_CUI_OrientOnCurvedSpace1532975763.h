...
// CurvedUI.CUI_OrientOnCurvedSpace
struct  CUI_OrientOnCurvedSpace_t1532975763  : public MonoBehaviour_t667441552
{
public:
	// CurvedUI.CurvedUISettings CurvedUI.CUI_OrientOnCurvedSpace::mySettings
	CurvedUISettings_t3567379076 * ___mySettings_2;

public:
	inline static int32_t get_offset_of_mySettings_2() { return static_cast<int32_t>(offsetof(CUI_OrientOnCurvedSpace_t1532975763, ___mySettings_2)); }
