...
// CurvedUI.CUI_RaycastToCanvas
struct  CUI_RaycastToCanvas_t581575746  : public MonoBehaviour_t667441552
{
public:
	// CurvedUI.CurvedUISettings CurvedUI.CUI_RaycastToCanvas::mySettings
	CurvedUISettings_t3567379076 * ___mySettings_2;

public:
	inline static int32_t get_offset_of_mySettings_2() { return static_cast<int32_t>(offsetof(CUI_RaycastToCanvas_t581575746, ___mySettings_2)); }
