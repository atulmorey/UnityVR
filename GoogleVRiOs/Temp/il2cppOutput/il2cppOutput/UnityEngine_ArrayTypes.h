...
// UnityEngine.Events.UnityEvent[]
struct UnityEventU5BU5D_t3959384002  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) UnityEvent_t1266085011 * m_Items[1];

public:
	inline UnityEvent_t1266085011 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline UnityEvent_t1266085011 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, UnityEvent_t1266085011 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
