...
public:
	...
	// UnityEngine.GameObject StoryModeUIController::TeleportationSystem
	GameObject_t3674682005 * ___TeleportationSystem_9;
	// System.Single StoryModeUIController::_gazeHoldTimer
	float ____gazeHoldTimer_10;
	// System.Int32 StoryModeUIController::_quiteTweenID
	int32_t ____quiteTweenID_11;
	// System.Int32 StoryModeUIController::_replayTweenID
	int32_t ____replayTweenID_12;
	// System.Int32 StoryModeUIController::_exploreTweenID
	int32_t ____exploreTweenID_13;
...
public:
	...
	inline static int32_t get_offset_of_TeleportationSystem_9() { return static_cast<int32_t>(offsetof(StoryModeUIController_t2758279528, ___TeleportationSystem_9)); }
	inline GameObject_t3674682005 * get_TeleportationSystem_9() const { return ___TeleportationSystem_9; }
	inline GameObject_t3674682005 ** get_address_of_TeleportationSystem_9() { return &___TeleportationSystem_9; }
	inline void set_TeleportationSystem_9(GameObject_t3674682005 * value)
	{
		___TeleportationSystem_9 = value;
		Il2CppCodeGenWriteBarrier(&___TeleportationSystem_9, value);
	}

	inline static int32_t get_offset_of__gazeHoldTimer_10() { return static_cast<int32_t>(offsetof(StoryModeUIController_t2758279528, ____gazeHoldTimer_10)); }
	inline float get__gazeHoldTimer_10() const { return ____gazeHoldTimer_10; }
	inline float* get_address_of__gazeHoldTimer_10() { return &____gazeHoldTimer_10; }
	inline void set__gazeHoldTimer_10(float value)
	{
		____gazeHoldTimer_10 = value;
	}

	inline static int32_t get_offset_of__quiteTweenID_11() { return static_cast<int32_t>(offsetof(StoryModeUIController_t2758279528, ____quiteTweenID_11)); }
	inline int32_t get__quiteTweenID_11() const { return ____quiteTweenID_11; }
	inline int32_t* get_address_of__quiteTweenID_11() { return &____quiteTweenID_11; }
	inline void set__quiteTweenID_11(int32_t value)
	{
		____quiteTweenID_11 = value;
	}

	inline static int32_t get_offset_of__replayTweenID_12() { return static_cast<int32_t>(offsetof(StoryModeUIController_t2758279528, ____replayTweenID_12)); }
	inline int32_t get__replayTweenID_12() const { return ____replayTweenID_12; }
	inline int32_t* get_address_of__replayTweenID_12() { return &____replayTweenID_12; }
	inline void set__replayTweenID_12(int32_t value)
	{
		____replayTweenID_12 = value;
	}

	inline static int32_t get_offset_of__exploreTweenID_13() { return static_cast<int32_t>(offsetof(StoryModeUIController_t2758279528, ____exploreTweenID_13)); }
	inline int32_t get__exploreTweenID_13() const { return ____exploreTweenID_13; }
	inline int32_t* get_address_of__exploreTweenID_13() { return &____exploreTweenID_13; }
	inline void set__exploreTweenID_13(int32_t value)
	{
		____exploreTweenID_13 = value;
	}
};
